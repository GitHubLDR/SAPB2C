 ...
 */
package com.sap.b2c.test.setup;
...
import com.sap.b2c.test.constants.Sapb2cTestConstants;
import com.sap.b2c.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = Sapb2cTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/sapb2ctest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/sapb2ctest/import/reviews.impex");

			LOG.info("Creating Test Payment Subscriptions...");
			getAcceleratorTestOrderData().createPaymentInfos();

			LOG.info("Creating CS Tickets...");
			importImpexFile(context, "/sapb2ctest/import/cstickets.impex");
			...
			importImpexFile(context, "/sapb2ctest/import/csquotes.impex");
		}
	}
}
