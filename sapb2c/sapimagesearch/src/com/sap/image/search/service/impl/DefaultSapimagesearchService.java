...
public class DefaultSapimagesearchService implements SapimagesearchService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultSapimagesearchService.class);
	...
	{
		return DefaultSapimagesearchService.class.getResourceAsStream("/sapimagesearch/sap-hybris-platform.png");
	}
