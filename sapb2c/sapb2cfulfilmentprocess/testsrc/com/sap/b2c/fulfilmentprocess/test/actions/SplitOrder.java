 ...
 */
package com.sap.b2c.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception
	{
		...
		warehouseCounter.setName(Sapb2cFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(Sapb2cFulfilmentProcessConstants.PARENT_PROCESS);
